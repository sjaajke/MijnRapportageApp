...
class PdfExportService {
  ...
  /// Same as [_defectLocationDashed] but for a Noodverlichting armatuur.
  String _noodverlichtingLocationDashed(NoodverlichtingInstallation inst) {
    return [
      inst.location,
      inst.locationA,
      inst.locationB,
  ...
  pw.Widget _noodverlichtingBlockExtern(NoodverlichtingInstallation inst) {
    ...
    return pw.Column(
      ...
      children: [
        ...
        _labelValue(
          'Locatie',
          inst.locationFull.isEmpty
              ? '-'
              : _noodverlichtingLocationDashed(inst),
          labelWidth: 140,
        ),
        pw.SizedBox(height: 6),
        pw.Row(
